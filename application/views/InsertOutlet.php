...
<?php if ($this->session->has_userdata('username')): ?>
	...
	<div class="row mt-5">
	<div class="container">
		<?= form_open('MyController/InsertOutlet', ['method' => 'POST']) ?>
        <center><h5 class="text">ADD NEW OUTLET</h5></center><hr>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="tlp_outlet" required>
            </div>

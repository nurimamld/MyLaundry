...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-lg-auto">
      <li class="nav-item">
        <a class="nav-link" href="<?= site_url('MyController/DataUser') ?>">User Data<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= site_url('MyController/DataPaket')?>">Package Data</a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="<?= site_url('MyController/DataOutlet')?>">Data Outlet</a>
      </li>

    </ul>
    <form class="form-inline my-2 my-lg-0">
      <a class="btn ml-1" href="<?= site_url('MyController/logout')?>">Logout</a>
    </form>
  </div>
</nav>
